...
import { HiOutlineLockClosed, HiOutlineUser, HiArrowRight, HiOutlineHeart } from 'react-icons/hi2';
                ...
                <div className="max-w-md mx-auto w-full">
                    ...
                    <form className="space-y-5">
                        ...
                        <div className="flex items-start">
                            <input id="terms" name="terms" type="checkbox" required className="mt-1 h-4 w-4 text-goldAccent focus:ring-goldAccent border-softSilver rounded" />
                        ...
                        <div className="pt-3">
                            <button
                                type="submit"
                                className="group w-full flex justify-center items-center gap-3 px-6 py-4 bg-goldAccent text-navyBlue font-bold rounded-lg hover:bg-navyBlue hover:text-pureWhite transition-all duration-300 text-sm tracking-wide shadow-lg hover:scale-[1.02]"
                            >
                                Buat Akun Gratis <HiArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </button>
                        </div>
                    </form>
